...
export default function PaidAdsPlan({ navigate, previousPage }: { navigate: (id: number) => void, previousPage?: number | null }) {
  return (
    <div className="space-y-12">
      <header className="space-y-4 border-b border-slate-200 pb-8 sm:pb-10">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-blue-950 leading-tight">Paid Ads Growth Engine</h2>
      ...
      <section className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-8 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 border-b border-slate-100 pb-4 gap-4">
          <h3 className="text-xl sm:text-2xl font-bold text-blue-950 flex items-center gap-3">
            <Users className="text-blue-500 w-6 h-6 sm:w-7 sm:h-7" /> The Audience Matrix
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 sm:p-6 shadow-inner">
            <h4 className="font-bold text-blue-900 text-base sm:text-lg mb-1">1. The High-Ticket Enterprise</h4>
            <p className="text-[10px] sm:text-sm font-bold text-blue-600 mb-4 tracking-wide uppercase">Real Estate Dev • Resorts • Edu</p>
            <div className="bg-white p-4 sm:p-5 rounded-xl shadow-sm border border-blue-100 h-full">
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-4">
                <strong className="text-blue-900 font-extrabold text-sm sm:text-base block mb-1">The Core Hook: "Remote Validation"</strong> 
              ...
              <div className="bg-slate-50 p-3 rounded border border-slate-100 text-[10px] sm:text-xs font-mono text-slate-500">Target: Net Worth, Expats, International Travelers.</div>
            </div>
          </div>
          
          <div className="bg-orange-50 border border-orange-100 rounded-xl p-5 sm:p-6 shadow-inner">
            <h4 className="font-bold text-orange-900 text-base sm:text-lg mb-1">2. The Local Conversion Driver</h4>
            <p className="text-[10px] sm:text-sm font-bold text-orange-600 mb-4 tracking-wide uppercase">Gyms • Banquets • Retail</p>
            <div className="bg-white p-4 sm:p-5 rounded-xl shadow-sm border border-orange-100 h-full">
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-4">
                <strong className="text-orange-900 font-extrabold text-sm sm:text-base block mb-1">The Core Hook: "Footfall Automation"</strong>
                These entities constantly battle local proximity competitors. Visual superiority and absolute transparency on Google Maps definitively results in hoarding local traffic over competitors who hide their interiors.
              </p>
              <div className="bg-slate-50 p-3 rounded border border-slate-100 text-[10px] sm:text-xs font-mono text-slate-500">Target: Business Owners within 5km radius.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm relative overflow-hidden">
        ...
        <div className="bg-orange-50/50 border border-orange-100 rounded-xl p-5 sm:p-6 mb-10 shadow-inner">
          ...
          <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
            Modern business leadership seeks to mitigate risk through data-backed phases. Our rollout mirrors this approach: instead of a full-scale commitment, we initiate <strong>Phase 1: The 'Blindfold' and 'Digital Window' ads.</strong> We shoot, deploy, and benchmark the ROI in local corridors. Once the target Customer Acquisition Cost (CAC) is established, we transition to high-fidelity cinematic scaling.
          </p>
        </div>
          ...
          <div className="space-y-12">
              ...
              <div className="flex-1 pt-1 sm:pt-2 w-full">
                <div className="flex flex-col md:flex-row md:items-center gap-2 mb-2">
                  <h4 className="text-xl font-bold text-blue-950 flex items-center gap-3">
                    TOFU: Awareness & Lead Velocity
                  </h4>
                  <span className="text-[10px] font-bold uppercase tracking-wider bg-slate-100 text-slate-500 px-2 py-1 rounded w-max">Top of Funnel</span>
                </div>
                
                <p className="text-slate-600 font-medium mb-3 text-sm sm:text-base">Objective: High-impact awareness & intent aggregation in core Navi Mumbai/Pune corridors.</p>
                <div className="bg-slate-50 rounded-xl p-5 border border-slate-200 text-sm sm:text-base text-slate-700 leading-relaxed shadow-inner">
                  <strong className="text-slate-900 block mb-1">Execution Strategy:</strong>
                  Deploy Level 1 and 2 "Digital Window" content to stop the scroll and filter high-interest prospects. We transform cold browsers into a retargeting pool for high-velocity conversion.
                </div>
              </div>
            </div>
            ...
            <div className="relative flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              ...
              <div className="flex-1 pt-1 sm:pt-2 w-full">
                <div className="flex flex-col md:flex-row md:items-center gap-2 mb-2">
                  <h4 className="text-xl font-bold text-blue-950 flex items-center gap-3">
                    MOFU: Evaluation & Physical Truth
                  </h4>
                  <span className="text-[10px] font-bold uppercase tracking-wider bg-orange-100 text-orange-600 px-2 py-1 rounded w-max">Middle of Funnel</span>
                </div>
                <p className="text-slate-600 font-medium mb-3 text-sm sm:text-base">Objective: Build unquestionable trust by providing spatial verification of the business.</p>
                <div className="bg-orange-50/50 rounded-xl p-5 border border-orange-100 text-sm sm:text-base text-slate-700 leading-relaxed shadow-inner">
                  <strong className="text-slate-900 block mb-1">Execution Strategy:</strong>
                  Retarget engaged TOFU viewers with detailed testimonials and Level 3 "Torn Photo" content. This stage explicitly lowers the "apprehension barrier" by proving digital transparency.
                </div>
              </div>
            </div>
            ...
            <div className="relative flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              ...
              <div className="flex-1 pt-1 sm:pt-2 w-full">
                <div className="flex flex-col md:flex-row md:items-center gap-2 mb-2">
                  <h4 className="text-xl font-bold text-blue-950 flex items-center gap-3">
                    BOFU: Conversion & Immediate Handoff
                  </h4>
                  <span className="text-[10px] font-bold uppercase tracking-wider bg-blue-100 text-blue-700 px-2 py-1 rounded w-max">Bottom of Funnel</span>
                </div>
                <p className="text-slate-600 font-medium mb-4 text-sm sm:text-base">Objective: Direct High-Intent capture and 1-on-1 consultation initiation.</p>
                <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5 sm:gap-4 relative overflow-hidden">
                  ...
                  <div className="pl-3">
                    <strong className="text-blue-950 block text-lg mb-1">Core CTA: "Direct Executive Activation"</strong>
                    <p className="text-slate-500 text-sm max-w-sm">Route hot prospects directly into the WhatsApp environment for immediate closing and service onboarding.</p>
                  </div>
                  <button 
                    onClick={() => {
                      const message = encodeURIComponent("Hello! I want to execute the Phase 1: Meta Ads strategy for my business. What's the next step?");
                  ...
                  >
                    Activate Strategy <ArrowRight className="w-4 h-4" />
                  </button>
                </div>
              </div>
            </div>
